...
// PANTALLA PRINCIPAL (3 botons + alertes)
function renderHome() {
  ...
  products.forEach(p => {
    ...
    // Compta alertes (taronja + vermell)
  ...
  // Badges (mostren el nombre d'urgents en cada secció)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (settingsLoc) settingsLoc.addEventListener('click', () => {
    renderLocationsList();
    showScreen('locations');
  });
