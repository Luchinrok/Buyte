...
- 🟡 **[UX] Afegir producte directe a manual** — el pas intermedi (triar entre manual / codi de barres) sobra el 99% dels cops. Fer que "Afegir producte" (BuyMe i EatMe) obri **directament el formulari manual**, i deixar el **codi de barres com a opció secundària** (icona d'escàner dins el formulari o en un racó), no com a bifurcació obligatòria prèvia.
