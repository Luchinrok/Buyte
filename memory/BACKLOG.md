...
- **Despeses i altres** — ~~cost mitjà cistella~~ **✅ FET v1 (11/06, `553ea3f`)**, ~~despesa per categoria~~ **✅ FET (11/06, `6f70cc1`)**, ~~pressupost mensual~~ **✅ FET v1 (11/06, `abd37ff`)**, ~~planificador setmanal de receptes~~ **✅ FET v1 (12/06, vegeu sota)**, recordatoris contextuals, revisar sistema d'Espais.
