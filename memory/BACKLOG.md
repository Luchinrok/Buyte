...
- **Despeses i altres** — ~~cost mitjà cistella~~ **✅ FET v1 (11/06, `553ea3f`)**, despesa per categoria, pressupost mensual, planificador setmanal de receptes, recordatoris contextuals, revisar sistema d'Espais.
